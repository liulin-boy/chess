...
module Chess
  class PieceTester < MiniTest::Unit::TestCase
    def test_same_as
      ...
      b1 = Bishop.new(3, 4, :white, game_board1)
      assert !b1.same_as?(Object.new)
      assert b1.same_as?(b1)

      b2 = Bishop.new(3, 4, :white, game_board1)
      assert b1.same_as?(b2)

      b3 = Bishop.new(4, 5, :white, game_board1)
      assert !b1.same_as?(b3)

      b4 = Bishop.new(3, 5, :white, game_board1)
      assert !b1.same_as?(b4)

      b5 = Bishop.new(3, 4, :black, game_board1)
      assert !b1.same_as?(b5)

      r1 = Rook.new(3, 4, :white, game_board1)
      assert !b1.same_as?(r1)

      r2 = Rook.new(4, 4, :white, game_board2)
      r2.move(3, 4)
    ...
    def test_range
      ...
      assert_equal expected_range, game_board.range
    end
