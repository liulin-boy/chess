watch('chess/lib/(.*)\.rb') do |match_file|
  ...
  if success
    # i'm using notification tool called growl.
    # unfortunately, here i have to use full path, because if i use relative path, growl just stops working on my machine:
